 ...
 */
export function suppressAntdConsoleWarning(customErrorHandler?: ErrorHandlerFunction, config: Partial<ErrorHandlingConfig> = {}): GlobalErrorHandlingResult {
  ...
  if (finalConfig.enableConsoleOverride) {
    ...
    console.warn = (...args) => {
      if (WarningFilter.shouldIgnore(args[0]))
        return
